...
if(!function_exists('wpjam_option_page')){
	include(WPJAM_BASIC_PLUGIN_DIR.'include/wpjam-setting-api.php');	// 加载 WPJAM 基础类库
}
...
include(WPJAM_BASIC_PLUGIN_DIR.'wpjam-hook.php');		// 基本优化
...
include(WPJAM_BASIC_PLUGIN_DIR.'wpjam-custom.php');		// 定制
...
include(WPJAM_BASIC_PLUGIN_DIR.'wpjam-message.php');	// 站内消息
